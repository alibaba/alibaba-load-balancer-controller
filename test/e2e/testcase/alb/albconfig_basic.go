...
func RunAlbConfigTestCases(f *framework.Framework) {
	...
	ginkgo.By("create albconfig")

	ginkgo.Describe("[alb][p0] alb-ingress-controller testcase: albconfig", func() {
		ginkgo.Context("albconfig create", func() {
			...
			ginkgo.It("albconfig base create", func() {
